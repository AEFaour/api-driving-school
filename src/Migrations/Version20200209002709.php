...
final class Version20200209002709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE learner ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE learner ADD CONSTRAINT FK_8EF3834A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_8EF3834A76ED395 ON learner (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8EF3834A76ED395 ON learner');
        $this->addSql('ALTER TABLE learner DROP user_id');
    }
}
